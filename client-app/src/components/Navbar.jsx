...
function Navbar() {
  ...
  return (
    <div className='sticky top-0 bg-[#3B3E47] shadow-2xl flex flex-wrap items-center justify-center sm:justify-between mt-10 mb-8 p-5 gap-5'>
        ...
        <div className='flex gap-7 items-center'>
          {/* using a tag below to refresh the page - so that the page fetches all results again irrespective of the filter */}
            ...
            <Link to={'/'}>
            <button className='text-sm'>Add More Members</button>
            </Link>
        </div>
    </div>
